...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 14 07:27:15 2018
@author: ginnyzhu
"""
...
#construct a whole module class from pytorch nn.module
#then we call this class in models after we define it 
class EHRnnModule(nn.Module):
    ...
    #add parameters for zero padding 
    def __init__(self, input_size, embed_dim ,hidden_size, n_layers=1,dropout_r=0.1,cell_type='LSTM', bii=False, time=False , preTrainEmb='', packPadMode = True):
        super(EHRnnModule, self).__init__()
